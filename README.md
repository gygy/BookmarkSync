...
For manual load (developer mode), get the latest packages (v1.1.10) from [dist/](dist/):

- [BookmarkSync-1.1.10-chrome.zip](dist/BookmarkSync-1.1.10-chrome.zip)
